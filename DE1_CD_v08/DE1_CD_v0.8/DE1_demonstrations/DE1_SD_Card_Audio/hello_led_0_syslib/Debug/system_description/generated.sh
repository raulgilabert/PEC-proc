...
#
# Generated: 2007-06-27 18:59:45.953
...
ptf=D:\keith_temp\quartusII\DE1_QIIv71\DE1_demonstrations\DE1_SD_Card_Audio\system_0.ptf
...
if test -f /cygdrive/c/altera/71/nios2eds/components/altera_hal/build/os.sh ; then
   . /cygdrive/c/altera/71/nios2eds/components/altera_hal/build/os.sh
fi
